...
export default function TermsPage() {
  return (
    <main style={wrap}>
      ...
      <p>{APP} is a Pi-native platform for creating, managing, and trading digital assets and NFTs, with payments in Pi. We may add, change, or discontinue features at any time.</p>
