...
const APP     = 'TEC Assets';
const DOMAIN  = 'assets.tecosystem.app';
...
export default function PrivacyPage() {
  return (
    <main style={wrap}>
      ...
      <p>The Elite Consortium (&quot;TEC&quot;, &quot;we&quot;, &quot;our&quot;, or &quot;us&quot;) operates {APP}, a Pi-native digital asset and NFT platform built on the Pi Network blockchain. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use {APP}. By accessing or using {APP}, you agree to this Privacy Policy.</p>
      ...
      <ul>
        ...
        <li>Record and transfer digital-asset ownership and provide support</li>
